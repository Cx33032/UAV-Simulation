...
void setup() {
    ...
    output = createWriter("../Movements/movements.json");
}
    ...
    for(int i = 1; i<=dots; i++){
        ...
        if(i%2==0){
            ...
            if(i%4==0){
                ...
                directionOutput = "forward";
                y2 = prevY - distance;
            }
            //Down
            else{
                // output.println("Direction: Back");
                directionOutput = "back";
                y2 = prevY + distance;
            }
        }
        //Horizontal movement
        ...
        String outputString = String.format("\t\t{\"direction\": \"%s\", \"duration\": %d}, ", directionOutput, duration);
        if(i == dots)
            outputString = String.format("\t\t{\"direction\": \"%s\", \"duration\": %d}", directionOutput, duration);
